...
vectorizer = TfidfVectorizer(ngram_range = (1, 1), stop_words = 'english', max_features = 9900) 
X = vectorizer.fit_transform(corpus)
vect = TfidfVectorizer(ngram_range = (1, 1), stop_words = 'english', max_features = 100) 
Y = vect.fit_transform(city)
X_ = hstack([X, Y])
print(X_.shape)
...
wt_file = open('features.location', 'w')
